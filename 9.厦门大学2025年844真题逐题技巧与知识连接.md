...
3. 需要近似时给出手算方法或合理区间；
4. 作图题列出所有决定图形的关键点；
5. 数学表达式统一使用独立公式块；短说明用公式块内的直立文字，兼容未启用行内数学的 Typora。
...
$$
\text{把特征方程中的变量替换后，} \text{乘以} (1-w)^2 \text{消去分母，} \text{得到}
$$
